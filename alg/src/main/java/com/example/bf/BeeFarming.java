...
public class BeeFarming extends JFrame {
    ...
    Music music = new Music("res/flourish.mid");
    ...
    public BeeFarming() {
        ...
        imgBee = getToolkit().getImage("res/bee.png");
        imgBee2 = getToolkit().getImage("res/bee2.png");
        imgBG = this.getToolkit().getImage("res/green.jpg");
        Image[] imgFlw = new Image[3];
        imgFlw[0] = this.getToolkit().getImage("res/flower0.png");
        imgFlw[1] = this.getToolkit().getImage("res/flower1.png");
        imgFlw[2] = this.getToolkit().getImage("res/flower2.png");
        ...
        bees[1] = new HoneyBee(0, 210, 210, 76, true, imgBee);
        bees[2] = new HoneyBee(1, 130, 150, 145, true, imgBee);
        bees[3] = new HoneyBee(2, 30, 370, 240, true, imgBee);
        ...
        try {
            int i = 0;
            Scanner input = new Scanner(new File("res/flowers.dat"));
            while (input.hasNext()) {
        ...
        if (angle_damp == 0) {
            for (int i = 1; i < 10; i++)
                if (bees[i] != null)//蜜蜂是否存在，死了会从数组里删除
                    if (bees[i].getlive() ) bees[i].search();
        }
        //延既定飞行路线飞行直到下一次搜索
        for (int i = 1; i < 10; i++)
            if (bees[i] != null)//蜜蜂是否存在，死了会从数组里删除
                if (bees[i].getlive()) bees[i].flying1(angle_damp);
        angle_damp++;
