...
public class HoneyBee3 extends Bee{
    ...
    private ArrayList<HoneyBee3.SearchFlower> FlowerSearch = new ArrayList<HoneyBee3.SearchFlower>();
    private ArrayList<HoneyBee3.SearchBee> BeeSearch = new ArrayList<HoneyBee3.SearchBee>();

    private int time = 0;//������ʱ�ı��۷���ת����
    private int SpiralDirection = 1;

    public HoneyBee3(int id,int x, int y, double angle,boolean isAlive,Image img){
    ...
    private void UpdateFlag() {
        ...
        //����ֻ�Է������۷���Ϣ��������д���
        if(BeeSearch.size()>0){
            HoneyBee3.SearchBee SB = new HoneyBee3.SearchBee(BeeSearch.get(BeeSearch.size()-1));//�õ����һֻ�۷����Ϣ
        ...
        for(int i=0;i<strs.length;i++){
            ...
            if(strs[i].indexOf('-')==0)
            {
                ...
                if(!s.equals("ON")){
                    ...
                    HoneyBee3.SearchFlower SF = new HoneyBee3.SearchFlower(honey,a%360);
                    FlowerSearch.add(SF);
                }
            ...
            if(strs[i].indexOf('+')==0){
                ...
                HoneyBee3.SearchBee SB = new HoneyBee3.SearchBee(id,a,b);
                BeeSearch.add(SB);
                //System.out.println(strs[i]);
            }
        }
    ...
    */
            ...
            case 0://��ʾ���ֻƷ䣬���Ʒ���ʱ��δ�����Լ�
                ...
                if(FlowerSearch.size()>0){//������л�
                    ...
                    for(int i = 0;i<FlowerSearch.size();i++){
                        HoneyBee3.SearchFlower SF = new HoneyBee3.SearchFlower(FlowerSearch.get(i));
    ...
    class SearchFlower{
        ...
        public SearchFlower(HoneyBee3.SearchFlower SF){
    ...
    class SearchBee{
        ...
        public SearchBee(HoneyBee3.SearchBee SB){
            this.id = SB.id;
